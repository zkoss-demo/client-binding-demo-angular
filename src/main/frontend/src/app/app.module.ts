import {APP_INITIALIZER, ErrorHandler, LOCALE_ID, NgModule, PLATFORM_ID, TRANSLATIONS, Injector} from '@angular/core';
...
import {DOCUMENT, isPlatformBrowser, registerLocaleData, APP_BASE_HREF} from '@angular/common';
